...
const AlumniInfoSurvey = () => {
    ...
    const {
        ...
        //     minLength: 4,
        //     required:
        //         "Must include atleast 4 field: Elementary, Senior High, College, etc.",
        // },
    });
        ...
        <div className="w-full py-8 flex flex-col items-center text-sm">
            ...
            >
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.firstName) &&
                        errors?.firstName && (
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.lastName) &&
                        errors?.lastName && (
                            <p className="text-sm font-poppins text-red">
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.age) && errors?.age && (
                        <p className="text-sm font-poppins text-red">
                            {errors?.age.message}
                        </p>
                    )}
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.gender) &&
                        errors?.gender && (
                            <p className="text-sm font-poppins text-red">
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.civilStatus) &&
                        errors?.civilStatus && (
                            <p className="text-sm font-poppins text-red">
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.address) &&
                        errors?.address && (
                            <p className="text-sm font-poppins text-red">
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.contactNumber) &&
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.emailAddress) &&
                        errors?.emailAddress && (
                            <p className="text-sm font-poppins text-red">
                    ...
                    {educationalBackgroundFields.map((field, index) => (
                        <div key={field.id} className="flex flex-col gap-1">
                            ...
                            <div>
                                ...
                                />
                                {(!!submitCount ||
                                    touchedFields?.educationalBackground?.[
                                        index
                                    ]?.educationalLevel) &&
                            ...
                            {index ===
                                educationalBackgroundFields.length - 1 && (
                                <hr className="text-grey-300 my-2" />
                            )}
                        </div>
                    ))}
                    {/* {(!!submitCount || touchedFields?.educationalBackground) &&
                        errors?.educationalBackground && (
                            <p className="text-sm font-poppins text-red">
                                Required
                            </p>
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.firstNameFather) &&
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.middleNameFather) &&
                        errors?.middleNameFather && (
                            <p className="text-sm font-poppins text-red">
                                {errors?.middleNameFather.message}
                            </p>
                        )}
                </div>
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.lastNameFather) &&
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.firstNameMother) &&
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.middleNameMothe) &&
                        errors?.middleNameMother && (
                            <p className="text-sm font-poppins text-red">
                                {errors?.middleNameMother.message}
                            </p>
                        )}
                </div>
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.lastNameMother) &&
                ...
                {trainingProgramsFields.map((field, index) => (
                    <div key={field.id} className="flex flex-col gap-1">
                        ...
                        <div>
                            ...
                            />
                            {!!submitCount ||
                                (touchedFields?.trainingPrograms?.[index]
                                    ?.title &&
                                    errors?.trainingPrograms?.[index]
                                        ?.title && (
                                        <p className="text-sm font-poppins text-red">
                                            {
                        ...
                        <div>
                            ...
                            {!!submitCount ||
                                (touchedFields?.trainingPrograms?.[index]
                                    ?.date &&
                                    errors?.trainingPrograms?.[index]?.date && (
                                        <p className="text-sm font-poppins text-red">
                                            {
                                                errors?.trainingPrograms?.[
                                                    index
                    ...
                    <div key={field.id} className="flex flex-col gap-1">
                        <div className="flex gap-2">
                            <div>
                                ...
                                />
                                {!!submitCount ||
                                    (touchedFields?.organizations?.[index] &&
                ...
                <div>
                    ...
                    />
                    {(!!submitCount || touchedFields?.srCode) &&
                        errors?.srCode && (
                            <p className="text-sm font-poppins text-red">
